...
(function () {
  const PAGES = [
    ...
    { href: "Banter.html",    label: "Banter" },
    { href: "News.html",      label: "News" },
  ];
  const ADMIN = { href: "#", label: "Admin", adm: true };

  // favicon / app-icon links (trophy mark)
  [
    ['icon', 'image/svg+xml', 'icon/worldcuppy-icon.svg', null],
    ['icon', 'image/png', 'icon/favicon-32.png', '32x32'],
    ['icon', 'image/png', 'icon/favicon-16.png', '16x16'],
    ['apple-touch-icon', null, 'icon/apple-touch-icon.png', null],
